// RUNNER GAME. ADAPTED BY DEFRAN22.
// https://proyectosinteresantes.com/10-juegos-arduino-lcd/?utm_source=youtube&utm_medium=web&utm_campaign=trafico_sitio
...
void buttonPush() // Handle the button push.
{
  buttonPushed=true;
}
...
void loop() 
{
  ...
  if (drawHero(heroPos, terrainUpper, terrainLower, distance >> 3)) 
  {
    ...
    noTone(melodyPin); tone(melodyPin, 200, 200);   // PORT, NOTE, TIME.
  } 
  else 
  {
